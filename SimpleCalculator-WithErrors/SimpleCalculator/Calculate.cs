    ...
    public class Calculate
    {
        ...
        public void CalculateNow()
        {
            ...
            do
            {
                ...
                PerformAction(actionCode, lastAnswer, lastInput, out answer);
        ...
        private void PerformAction(Action actionCode, int lastAnswer, string lastInput, out int answer)
        {
            answer = 0;
            switch (actionCode)
            {
        ...
        public Action ValidateInput(string currentInput)
        {
            ...
            {
                // For now just printing a message saying that the input is not valid.
